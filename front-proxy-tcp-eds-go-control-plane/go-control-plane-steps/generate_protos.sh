...
echo "correcting imports"
grep -irl "core.*\"envoy/api/v2/core\"" * --exclude-dir=build| xargs sed -i '' 's#core.*"envoy/api/v2/core"#core "github.com/envoyproxy/go-control-plane/envoy/api/v2/core"#g'
